...
Examples:
    package_skill.py plugins/stuffbucket/skills/my-skill
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nExamples:")
        print("  package_skill.py plugins/stuffbucket/skills/my-skill")
        print("  package_skill.py plugins/stuffbucket/skills/my-skill ./dist")
        sys.exit(1)
