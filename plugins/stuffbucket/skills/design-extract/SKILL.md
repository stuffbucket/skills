---
name: design-extract
description: Extract and consolidate reusable components, design tokens, and patterns into your design system. Identifies opportunities for systematic reuse and enriches your component library. Use when asked to create components, refactor repeated UI patterns, build a design system, or extract tokens.
metadata:
  author: stuffbucket
  version: 1.0.0
---
...
**Reference files** (read when analyzing design system structure or creating tokens):

- `references/design-systems.md` — Token categories, theming, component specs, naming conventions
- `references/design-system-template.md` — Meta-framework for fixed, project-specific, and adaptable elements
