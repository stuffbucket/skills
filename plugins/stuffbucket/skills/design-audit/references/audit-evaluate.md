...
1. **Identify UI files** — Use Glob to find front-end files (tsx, jsx, vue, svelte, html, css). If a
   path was provided, scope to that path. If not, look for common UI directories (src/components,
   src/pages, app/, pages/, etc.).
